...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initScrollAnimado)\n/* harmony export */ });\nvar activeClass = \"ativo\";\nfunction initScrollAnimado() {\n  var sections = document.querySelectorAll(\"[data-anime='scroll']\");\n  var windowsMetade = window.innerHeight * 0.5;\n  function animaScroll() {\n    sections.forEach(function (section) {\n      var sectionTop = section.getBoundingClientRect().top;\n      var isSectionVisible = sectionTop - windowsMetade < 0;\n      if (isSectionVisible) section.classList.add(activeClass);else if (section.classList.contains('ativo')) {\n        section.classList.remove(activeClass);\n      }\n    });\n  }\n  if (sections.length) {\n    animaScroll();\n    window.addEventListener(\"scroll\", animaScroll);\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./script/modules/scroll-animacao.js?");
